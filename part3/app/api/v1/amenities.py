...
class AmenityList(Resource):
    ...
    def get(self):
        ...
        # Utilisation correcte de la méthode `get_all_amenities`
        amenities, _ = facade.get_all_amenities()  # Déballage pour ignorer le total
        return amenities, 200  # Retourne directement la liste d'amenities
